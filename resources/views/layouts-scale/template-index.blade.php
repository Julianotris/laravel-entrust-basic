...
<head>
  ...
  <link rel="stylesheet" href={{ URL::asset("scale-template/css/bootstrap.css") }} type="text/css" />
  <link rel="stylesheet" href={{ URL::asset("scale-template/css/animate.css") }} type="text/css" />
  <link rel="stylesheet" href={{ URL::asset("scale-template/css/font-awesome.min.css") }} type="text/css" />
  <link rel="stylesheet" href={{ URL::asset("scale-template/css/icon.css") }} type="text/css" />
  <link rel="stylesheet" href={{ URL::asset("scale-template/css/font.css") }} type="text/css" />
  <link rel="stylesheet" href={{ URL::asset("scale-template/css/app.css") }} type="text/css" />
  <link rel="stylesheet" href={{ URL::asset("scale-template/js/calendar/bootstrap_calendar.css") }} type="text/css" />
  <!--[if lt IE 9]>
...
<body class="">
              ...
              <div class="list-group list-group-alt">
                <a href="#" class="media list-group-item">
                  <span class="pull-left thumb-sm">
                    <img src={{ URL::asset("scale-template/images/a0.png") }} alt="..." class="img-circle">
                  </span>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <span class="thumb-sm avatar pull-left">
              <img src={{ URL::asset("scale-template/images/a0.png") }} alt="...">
            </span>
                  ...
                  <div class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <span class="thumb avatar pull-left m-r">
                        <img src={{ URL::asset("scale-template/images/a0.png") }} class="dker" alt="...">
                      ...
                      <section class="panel b-a">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="m-b">
                            ...
                            <a href="#" class="avatar thumb-sm">
                              <img src={{ URL::asset("scale-template/images/a1.png") }} alt="...">
                              <i class="busy b-white"></i>
                            </a>
                            <a href="#" class="avatar thumb-sm">
                              <img src={{ URL::asset("scale-template/images/a2.png") }} alt="...">
                              <i class="away b-white"></i>
                            </a>
                            <a href="#" class="avatar thumb-sm">
                              <img src={{ URL::asset("scale-template/images/a3.png") }} alt="...">
                        ...
                        <ul class="list-group list-group-lg no-bg auto">
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src={{ URL::asset("scale-template/images/a4.png") }} alt="...">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src={{ URL::asset("scale-template/images/a5.png") }} alt="...">
                              <i class="on b-white bottom"></i>
                            </span>
                            <span class="clear">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src={{ URL::asset("scale-template/images/a7.png") }} alt="...">
  ...
  <script src={{ URL::asset("scale-template/js/jquery.min.js") }}></script>
  <!-- Bootstrap -->
  <script src={{ URL::asset("scale-template/js/bootstrap.js") }}></script>
  <!-- App -->
  <script src={{ URL::asset("scale-template/js/app.js") }}></script>
  <script src={{ URL::asset("scale-template/js/slimscroll/jquery.slimscroll.min.js") }}></script>
    <script src={{ URL::asset("scale-template/js/charts/easypiechart/jquery.easy-pie-chart.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/sparkline/jquery.sparkline.min.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/flot/jquery.flot.min.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/flot/jquery.flot.tooltip.min.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/flot/jquery.flot.spline.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/flot/jquery.flot.pie.min.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/flot/jquery.flot.resize.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/flot/jquery.flot.grow.js") }}></script>
  <script src={{ URL::asset("scale-template/js/charts/flot/demo.js")}}></script>

  <script src={{ URL::asset("scale-template/js/calendar/bootstrap_calendar.js") }}></script>
  <script src={{ URL::asset("scale-template/js/calendar/demo.js") }}></script>

  <script src={{ URL::asset("scale-template/js/sortable/jquery.sortable.js") }}></script>
  <script src={{ URL::asset("scale-template/js/app.plugin.js") }}></script>
</body>
</html>